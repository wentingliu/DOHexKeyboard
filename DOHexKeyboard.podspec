#
# Be sure to run `pod spec lint DOHexKeyboard.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.description  = <<-DESC
  #                   An optional longer description of DOHexKeyboard
  #    
  #                   * Markdown format.
  ...
  # s.authors      = { "Wenting Liu" => "wentingliu@live.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'Wenting Liu', 'other author'
